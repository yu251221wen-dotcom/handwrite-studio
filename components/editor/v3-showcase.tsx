...
function project(noTemplateMode: ProjectState["noTemplateMode"]): ProjectState {
  const base: ProjectState = { schemaVersion: 3, projectVersion: "3.1.1", id: `showcase-${noTemplateMode}`,
    ...
    fieldMappings: [], pages: [], handwriting, exportSettings: { pageSize: "A4", dpi: 300, format: "pdf", jpgQuality: 0.9 }, updatedAt: "2026-01-01T00:00:00.000Z" };
